...
- IDT Root Focus notes and grounded branch chat: `docs/architecture/idt-root-focus-chat.md`
- Founder/Admin current business diagnosis, replacement lifecycle, and Excel export: `docs/architecture/business-diagnosis.md`
